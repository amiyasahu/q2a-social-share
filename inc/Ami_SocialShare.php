    ...
    class Ami_SocialShare extends BasicModel
    {
        ...
        public function getStyleButtonTemplates( $style )
        {
            $styles = array(
                ...
                qa_sss_opt::SHARE_TYPE_COLORED_BTNS           => '<span class="btn-share"><a href="{{url}}" target="{{target}}" rel="external nofollow" class="social-share-btn btn-social btn-no-icon btn-{{class}}" title="{{title}}">{{text}}</a></span>',
                qa_sss_opt::SHARE_TYPE_COLORED_BTNS_WITH_ICON => '<span class="btn-share with-icon"><a href="{{url}}" target="{{target}}" rel="external nofollow" class="social-share-btn btn-social btn-{{class}}" title="{{title}}">{{icon}} {{text}}</a></span>',
                qa_sss_opt::SHARE_TYPE_FI_SQ                  => '<span class="btn-share only-icon"><a href="{{url}}" target="{{target}}" rel="external nofollow" class="social-share-btn btn-social btn-social-icon btn-sqr btn-{{class}}" title="{{title}}">{{icon}}</a></span>',
                qa_sss_opt::SHARE_TYPE_FI_SEMI_ROUNDED        => '<span class="btn-share only-icon semi-rounded"><a href="{{url}}" target="{{target}}" rel="external nofollow" class="social-share-btn btn-social btn-social-icon btn-semi-rounded btn-{{class}}" title="{{title}}">{{icon}}</a></span>',
                qa_sss_opt::SHARE_TYPE_FI_ROUNDED             => '<span class="btn-share only-icon rounded"><a href="{{url}}" target="{{target}}" rel="external nofollow" class="social-share-btn btn-social btn-social-icon btn-rounded btn-{{class}}" title="{{title}}">{{icon}}</a></span>',
                qa_sss_opt::SHARE_TYPE_ANIMATED_FI            => '<span class="btn-share only-icon amimated"><a href="{{url}}" target="{{target}}" rel="external nofollow" class="social-share-btn btn-social btn-social-icon btn-sqr-animated btn-{{class}}" title="{{title}}">{{icon}}</a></span>',
            );
